...
def prepare_database():
    try:
        ...
        student_names = ['Иван', 'Мария', 'Петр', 'Анна', 'Алексей', 'Елена',
                         'Сергей', 'Ольга', 'Владимир', 'Татьяна']
        ...
        for i in range(1, 31):  # Заполним таблицу 30 случайными записями
            ...
            cur.execute('''INSERT INTO students (student_name, 
            group_number, course, age) 
                           VALUES (?, ?, ?, ?)''',
                        (student_name, group_number, course, age))
